...
/**
 * Created by app on 2017/8/8.
 */

public class ClassicsHeaderM extends RelativeLayout implements RefreshHeader {
    ...
    public ClassicsHeaderM(Context context) {
        super(context);
        this.initView(context, null);
    }

    public ClassicsHeaderM(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public ClassicsHeaderM(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public ClassicsHeaderM(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        layout.addView(mLastUpdateText, lpUpdateText);
        ...
        mShared = context.getSharedPreferences("ClassicsHeaderM", Context.MODE_PRIVATE);
...
//    }
    ...
    public ClassicsHeaderM setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }
    public ClassicsHeaderM setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }
    public ClassicsHeaderM setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }
    public ClassicsHeaderM setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }
    public ClassicsHeaderM setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }
    public ClassicsHeaderM setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public ClassicsHeaderM setLastUpdateTime(Date time) {
        mLastTime = time;
    ...
    public ClassicsHeaderM setTimeFormat(DateFormat format) {
        mFormat = format;
        mLastUpdateText.setText(mFormat.format(mLastTime));
        return this;
    }

    public ClassicsHeaderM setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public ClassicsHeaderM setAccentColor(int accentColor) {
        if (mArrowDrawable != null) {
