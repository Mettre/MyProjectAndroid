...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(MyApplication.getInstances().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(MyApplication.getInstances().getResources().getString(resId), args), duration);
    }
     ...
     * 显示加入购物车成功Toast
     */
    public static void imageToastShow(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.popup_add_success, null);
     ...
     * 显示关注商品成功Toast
     */
    public static void imageToastShow2(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.popup_add_success, null);
        TextView textView = (TextView) view.findViewById(R.id.title);
        textView.setText("关注成功");
        mViewToast = new Toast(context);
        mViewToast.setGravity(Gravity.CENTER, 0, 0);
        mViewToast.setDuration(200);
        mViewToast.setView(view);
        mViewToast.show();
    }
